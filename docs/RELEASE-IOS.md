...
1. **An app record must exist** in App Store Connect for `com.mrwd.bookstable`.
...
3. **Test information** is required before anyone outside the team can be invited:
   ...
   <https://books-table-six.vercel.app/privacy.html> answers 200 and is the one to use.
