...
`ios/App/BooksTableWidget/` holds the SwiftUI, and `ios/App/App/WidgetBridge.swift` is a
small in-app Capacitor plugin that hands it data.

The two processes meet in an **App Group** (`group.com.mrwd.bookstable`): the app writes a snapshot
