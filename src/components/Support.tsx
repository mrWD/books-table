  ...
  return (
    <div className={`supportdial${open ? ' open' : ''}`}>
      ...
      <button
        ...
        aria-label={open ? 'Close support links' : 'Support BooksTable'}
        aria-expanded={open}
        title="Support BooksTable"
        onClick={() => setOpen((v) => !v)}
      >
  ...
  return (
    <div className="support">
      <p className="support-text">
        BooksTable is free and has no ads. If it is useful to you, you can support it:
      </p>
